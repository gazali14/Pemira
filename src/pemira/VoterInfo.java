...
static String dname, dnim, dage, dtingkat, dkelas, demail, dcand;
    ...
    private void initComponents() {
        ...
        try {
            ...
            nim = new javax.swing.JFormattedTextField(mf);
            try {
                ...
                cast.setBackground(new java.awt.Color(0, 0, 153));
                ...
                kelas.setFont(new java.awt.Font("Raleway SemiBold", 0, 11)); // NOI18N
                kelas.setToolTipText("Masukan kelas Anda");
            ...
            nim.setToolTipText("Please enter your NIM in the speciified format.");
            nim.setName(""); // NOI18N
        ...
        tingkat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tingkat 1", "Tingkat 2", "Tingkat 3", "Tingkat 4" }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cand, 0, 251, Short.MAX_VALUE)
    ...
    private void castActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_castActionPerformed
        ...
        dnim = nim.getText();
        dage = age.getText();
        dtingkat = tingkat.getSelectedItem().toString();
        dkelas = kelas.getText();
       ...
       //-----------------------
        ...
        try{
            ...
            pstmt.setString(2,dnim);
            pstmt.setInt(3,Integer.parseInt(dage));
            pstmt.setString(4,dtingkat);
            pstmt.setString(5,dkelas);
            pstmt.setString(6,demail);
            pstmt.setString(7,dcand);
            pstmt.executeUpdate();
            JOptionPane.showMessageDialog(null,"Voting Succesfull");
            conn.close();             
...
//        age.setText("00");}
    ...
    private void kelasFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_kelasFocusGained
        if(kelas.getText().trim().toLowerCase().equals("Masukan kelas Anda")){
        kelas.setText("");}
    }//GEN-LAST:event_kelasFocusGained

    private void kelasFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_kelasFocusLost
        if(kelas.getText().trim().equals("") || kelas.getText().trim().toLowerCase().equals("Masukan kelas Anda :")){
        kelas.setText("Masukan kelas Anda : ");}
